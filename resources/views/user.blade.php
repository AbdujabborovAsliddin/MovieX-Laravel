...
<div class="mt-32">
    <h1 class="text-center mb-5 text-3xl">Register User</h1> 
<form class="max-w-sm mx-auto w-96" action="{{ route('register.store') }}" method="POST">
    @csrf
    @if ($errors->any())
            <ul>
            ...
            @endif
    <div class="mb-5">
        <label name="username" for="username" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Username</label>
    ...
    <div class="mb-5">
        <label name="password" for="password" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Password</label>
    ...
    <div class="flex justify-between items-center">
        ...
        <a class="hover:underline" href="{{ route('login') }}">Already have Account?</a>
    </div>
  </form>
