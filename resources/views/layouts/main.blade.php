...
<body class="bg-gray-900 h-screen text-white font-sans font-semibold flex flex-col justify-between">
    <div>
        <nav class="fixed w-full z-20 top-0 start-0 bg-gray-900 border-b">
            ...
            <div class="container mx-auto flex flex-col md:flex-row items-center justify-between px-16 py-6">
                ...
                <div class="flex flex-col md:flex-row items-center">
                    ...
                    @if(Auth::check())
                    <a class="ml-3 border-none bg-orange-500 border rounded-full" href="#">
                        <img class="w-9 h-9" src="/img/ava{{auth()->user()->avatar}}.png" alt="a">
                    </a>
                    <form action="{{ route('user') }}" method="get">
                        <button class="ml-4 hover:underline" type="submit">{{ auth()->user()->username }}</button>
                    </form>
                    @else
                    <a class="ml-3 border-none bg-orange-500 border rounded-full" href="{{ route('register') }}">
    ...
    <div>
        <footer class="bg-gray-900 shadow border-t-2 border-gray-700">
            <div class="w-full max-w-screen-xl h-24 mx-auto p-4 md:py-8">
                <div > 
