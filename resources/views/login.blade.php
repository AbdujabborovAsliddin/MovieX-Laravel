...
<form class="max-w-sm mx-auto w-96" action="{{ route('login.show') }}" method="POST">
    ...
    <div class="mb-5">
     ...
     <div class="mb-5">
      ...
      <input name="password" placeholder="password" type="password" id="password" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
    </div> 
...
{{-- <div class="mt-3 mx-auto">
    ...
    <div class="flex justify-between items-center">
        ...
        <a class="hover:underline" href="{{ route('register') }}">Don't registered yet?</a>
    </div>
  </form>
